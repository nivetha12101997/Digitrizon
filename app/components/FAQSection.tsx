...
const faqs = [
    { question: "What services does DIGITRIZON offer?", answer: "DIGITRIZON provides mobile app development, web app development, e-commerce development, SaaS product development, and digital marketing services for startups and growing businesses. We design each solution to be scalable, high-performance, and aligned with your long-term goals." },
    { question: "How long does it take to develop an app, website, e-commerce platform or digital product?", answer: "Most projects take anywhere from a few weeks to a few months. After understanding your requirements, we create a timeline with clear milestones to keep development fast, structured, and predictable." },
    ...
    { question: "Can you help if I only have an idea and no technical knowledge?", answer: "Absolutely. Many founders come to us with just an idea, whether it's a mobile app, e-commerce platform, or SaaS product. We guide you through planning, UI/UX design, development, and launch, making the entire process simple and stress-free."},
    { question: "How much does it cost to build a digital product or run growth activities?", answer: "Pricing totally depends on your requirements, features, and overall scope. We offer flexible options for mobile app development, web development, e-commerce development, SaaS product development, and digital growth services. Share your ideas or goals, and we’ll give you a clear estimate." },
    ...
    { question: "Do you take on small projects or startup-sized budgets?", answer: "Yes. DIGITRIZON works with startups, small teams, and growing businesses that need reliable mobile app development, web development, e-commerce solutions, SaaS product development, or digital growth support. We offer flexible engagement models so you can start small and scale as you grow." },
